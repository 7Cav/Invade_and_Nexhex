...
blufor_vehicle_variants_attackRotaryWing_unguided_deploymentData = [];
blufor_vehicle_variants_attackFixedWing_deploymentData = [];
blufor_vehicle_variants_attackFixedWing_unguided_deploymentData = [];
...
blufor_vehicle_attackRotaryWing_unguided_classes = [];
blufor_vehicle_attackFixedWing_classes = [];
blufor_vehicle_attackFixedWing_unguided_classes = [];
...
_variantDataList = [
	...
	, ["blufor_vehicle_variant_attackRotaryWing_unguided"
		,blufor_vehicle_variants_attackRotaryWing_unguided_deploymentData
		,blufor_vehicle_attackRotaryWing_unguided_classes
	]
	...
	, ["blufor_vehicle_variant_attackFixedWing_unguided"
		,blufor_vehicle_variants_attackFixedWing_unguided_deploymentData
		,blufor_vehicle_attackFixedWing_unguided_classes
	]
